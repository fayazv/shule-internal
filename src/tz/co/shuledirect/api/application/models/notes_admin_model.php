...
class Notes_admin_model extends CI_Model {
    ...
    function addContent($parentId,$newContent)
    {
        ...
        $note_type_id_row = $note_type_id_query->row();
        $note_type_id = $note_type_id_row->id; 
        ...
        $position_row = $position_query->row();
        $position = $position_row->position;
        $insert = $this->db->query("INSERT INTO notes (content,position,note_type_id,parent_notes_id,language_id) VALUES (".$this->db->escape($newContent).",$position,$note_type_id,$parentId,$this->englishLanguageId);");
